...
class ModelC(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Conv2d(3, 96, kernel_size=(3, 3), padding='same')
        self.layer2 = nn.Conv2d(96, 96, kernel_size=(3, 3), padding='same')

        self.layer3 = nn.Conv2d(96, 96, kernel_size=(3, 3), padding='same')#, stride=(2, 2))
        self.layer3_dropout = nn.Dropout(p=0.5)

        self.layer4 = nn.Conv2d(96, 192, kernel_size=(3, 3), padding='same')
        ...
        self.layer6_dropout = nn.Dropout(p=0.5)
    ...
    def forward(self, x):
        ...
        x = F.relu(self.layer3_dropout(self.layer3(x)))
        x = F.relu(self.layer4(x))
        x = F.relu(self.layer5(x))
        x = F.relu(self.layer6_dropout(self.layer6(x)))
